...
public class ImplicitWait {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //No need of using everytime thread.sleep instead we can use implicitWait
        //If we are using implicit wait then after every element automatically the wait will perform
